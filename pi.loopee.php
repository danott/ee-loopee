...
The "foreach" parameter lets you specify your values, separated by the | (pipe) character. If you need a pipe character in your value, you can escape it with \| (backslash)(pipe).

{loopee_key} can be used to get the 0-offset index of your parameter. (Like in a PHP array.)
{loopee_value} is the value.
...
{loopee_key} is the pre-colon key.
{loopee_value} is post-colon value.
...
That trailing comma is annoying. Like many built-in ExpressionEngine tags, the 'backspace' parameter is available.

{exp:loopee forint="5" to="25" by="5" backspace="1"}{loopee_value},{/exp:loopee}

This would prodce the more appealing

5,10,15,20,25

BONUS: You can use custom tats with both a forint loop or a foreach loop using the 'as' parameter. Modifying our loops from previous examples.
